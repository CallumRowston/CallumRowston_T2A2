...
def grant_admin_access(user_id):
    """Allows an admin to give another user admin privileges
    Args:
        user_id (int): id number of user to be granted admin access
    Returns:
...
def remove_admin_access(user_id):
    """Allows an admin to remove another users admin privileges
    Args:
        user_id (int): id number of user to have admin access removed
    Returns:
        dict: Success or error message
    """
    authorize_user()
